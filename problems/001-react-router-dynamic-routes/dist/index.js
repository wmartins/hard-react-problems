...
/***/ function(module, exports, __webpack_require__) {
	...
	var mountDOMNode = document.querySelector('#js-react-app');

	// webpack
	__webpack_require__(214);
	__webpack_require__(219);

	_reactDom2.default.render(_react2.default.createElement(_router2.default, null), mountDOMNode);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _news = __webpack_require__(210);

	var _news2 = _interopRequireDefault(_news);

	var _newsDetail = __webpack_require__(213);
	...
	exports.default = function () {
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                _reactRouter.Route,
	                { path: 'news', component: _news2.default },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Header = function (_React$Component) {
	    ...
	    _createClass(Header, [{
	        key: 'render',
	        value: function render() {
	            var linkClasses = ['inline-block', 'p2', 'aqua'].join(' ');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _newsBackend = __webpack_require__(211);

	var _newsBackend2 = _interopRequireDefault(_newsBackend);

	var _newsItem = __webpack_require__(212);
	...
	var News = function (_React$Component) {
	    ...
	    function News(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(News).call(this, props));
	    ...
	    _createClass(News, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            _newsBackend2.default.list().then(function (news) {
	                _this2.setState({
	                    isLoading: false,
	                    news: news
	                });
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                this.state.news.map(function (news) {
	                    return _react2.default.createElement(_newsItem2.default, _extends({
	                        key: news.id
	                    }, news));
	                }),
...
/***/ function(module, exports) {
	...
	var getListMock = function getListMock() {
	...
	var getDetailMock = function getDetailMock(id) {
	    return new Promise(function (resolve, reject) {
	        setTimeout(function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NewsItem = function (_React$Component) {
	    ...
	    function NewsItem(props) {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(NewsItem).call(this, props));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NewsDetail = function (_React$Component) {
	    ...
	    function NewsDetail(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(NewsDetail).call(this, props));
	    ...
	    _createClass(NewsDetail, [{
	        ...
	        value: function loadNews(id) {
	            ...
	            _newsBackend2.default.detail(id).then(function (news) {
	                _this2.setState({
	                    isLoading: false,
	                    news: news
	                });
